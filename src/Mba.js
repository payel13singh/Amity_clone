    ...
    return(
        <div className="container-fluid">
          <Navbarindex/>
           {/* <!-- 2nd div start --> */}
      <div class="row mt-5">
        <div class="col-md-6 bbadiv">
            <h2 className="program pgh1 m-5" >PG PROGRAM</h2>
            <h1 className=" mt-5 ms-5  pgh2 ">Master of business Administration
    ...
    {/* close */} 
     ...
     <div className="row mt-5">
        ...
        <div className="col-md-3">
            ...
            <h1 className="mx-4 mt-5">RS.8,292</h1>
...
{/* <!-- 4th div close --> */}
   ...
   <div className="row mt-5 bcamain" id="section1">
            <div className="col-md-7 bca5">
              <h1 className="mt-5 mx-5 build">Enhance your Career With<br></br> india 's' Premier Online BCA</h1> 
              <p  className="mt-5 mx-5 bcap"><i>
               our master of business Administrationis a 2 years (4 semesters) <br></br>
                 program to help you gain a comprehensive<br></br>
                understanding of the business world and thrive in a global marketplace .learn from industry experts <br></br>
                engage in real-world case studies, and put theory into <br></br> 
                practice through internships and projects. Join a dynamic group of students and create invaluable<br></br>
                connections with your peers remotely. Excel in the professional world with our online MBA program with advance learning and flexing modules.
    ...
    <div class="card">
      ...
      <div id="collapseOne" class="collapse show" data-bs-parent="#accordion">
        <div class="card-body">
        <h5 className='mbah5'>1.Managerial Economics
        2.Statistics for Management<br></br>
      3.Professional communication<br></br>
      4.Accounting for Managers<br></br>
        5.Marketing Management</h5>
...
Conflict Resolution and Management</h5>
    ...
    <div class="card">
      ...
      <div id="collapseThree" class="collapse" data-bs-parent="#accordion">
        <div class="card-body">
          <h5 className='mbah5'>Strategic Management<br></br>
Minor Projet<br></br>
Professional Ethics<br></br>
Specialization Elective 1<br></br>
Specialization Elective 2<br></br>
Specialization Elective 3<br></br>
Specialization Elective 4</h5>
        </div>
      </div>
    </div>
    <div class="card">
      ...
      <div id="collapsefour" class="collapse" data-bs-parent="#accordion">
        <div class="card-body">
         <h5 className='mbah5'>Major Project<br></br>
Management in Action Social Economic and Ethical Issues<br></br>
Digital Marketing<br></br>
Specialization Elective 1<br></br>
Specialization Elective 2</h5>
        </div>
      </div>
    </div>
    <div class="card">
      ...
      <div id="collapsefive" class="collapse" data-bs-parent="#accordion">
        <div class="card-body">
         <h5 className='mbah5'>Business Analytics<br></br>
Data Science<br></br>
Digital Entrepreneurship<br></br>
Digital Marketing Management<br></br>
Entrepreneurship and Leadership Management<br></br>
Finance and Accounting Management<br></br>
Global Finance Market<br></br>
Hospitality Management<br></br>
Human Resource Management<br></br>
Human Resources Analytics<br></br>
Information Technology Management<br></br>
Insurance Management<br></br>
International Business Management<br></br>
International Finance(ACCA)<br></br>
Marketing & Sales Management<br></br>
Petroleum and Natural Gas Management<br></br>
Production and Operations Management<br></br>
Retail Management<br></br>
Online MB</h5>
        </div>
      </div>
    </div>
...
<div  className='col-md-6'>
                ...
                <div class="row">
                    <div className="col-md-4 ">
                        ...
                        <h1 className="p-3 div11h1">rs.8,292</h1>
                    </div>
                    ...
                    <div className="col-md-4 ">
                        <div className="p-3 bg-light div11h">
                            ...
                            <h1 className="p-2 div11h1">rs.49,750</h1>
                        </div>
                    </div>
                    <div className="col-md-4 ">
                      <div className="p-2 bg-light div11h">
                        <p className="p-4">full Course Fee</p>
                        <h1 className="p-3 div11h1">rs.1,99,000</h1>
                      </div>  
                    </div>
