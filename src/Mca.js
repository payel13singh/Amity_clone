...
function Mca(){
   ...
   <div className="row mt-5 ">
        ...
        <div className="col-md-6 bbadiv ms-5">
            <h2 className="program pgh1 m-5" >PG PROGRAM</h2>
            <h1 className=" mt-5 ms-5  pgh2 ">Master of computer Application....
    ...
    <div className="modal-content">
      ...
      <div className="modal-footer">
        ...
        <div class="col-md-6">
         ...
         <img src="./bcaimages/mcagirl.webp" class="img-fluid"/>
...
{/* <!-- 4th div close --> */}
   ...
   <div className="row mt-5 bcamain" id="section1">
            <div className="col-md-7 bca5">
              <h1 className="mt-5 mx-5 build">Become A master at<br></br></h1> 
              <p  className="mt-5 mx-5 bcap"><i>
              Our Master of Computer Application is a 2 year (4 semesters)<br></br>
               program that prepares you for the IT sector by teaching you<br></br>
                the fundamentals of programming constructs and application<br></br>
                 modelling.Learn from renowned international faculty online<br></br>
    ...
    <div class="card">
      ...
      <div id="collapseOne" class="collapse show" data-bs-parent="#accordion">
        <div class="card-body">
        <h5 className='mbah5'>Professional communication<br></br>
Core Java<br></br>
Advanced Database Management Systems<br></br>
Advanced Software Engineering Principles<br></br>
Graph Theory and Combinatorics</h5>
    ...
    <div class="card">
      ...
      <div id="collapseTwo" class="collapse" data-bs-parent="#accordion">
        <div class="card-body">
          <h5 className='mbah5'>1.Research Methodology<br></br>
           2.date  Structures and Algorithm Design<br></br>
          3. Cognitive Analytics and Social Skills for Professional<br></br>
           4.Network Security and Cryptography</h5>
        </div>
      </div>
    </div>
    <br></br>
    <div class="card">
      ...
      <div id="collapseThree" class="collapse" data-bs-parent="#accordion">
        <div class="card-body">
          ...
          Unix /Linux Programming<br></br>
Seminar(Evaluation)<br></br>
Cloud Infrastructure and Services<br></br>
Quantitative Aptitude<br></br>
Professional Ethics   </h5>
    ...
    <div class="card">
      ...
      <div id="collapsefour" class="collapse" data-bs-parent="#accordion">
        <div class="card-body">
         <h5 className='mbah5'>Augmented Reality and Virtual Reality<br></br>
Blockchain Technology and Management : Business Management<br></br>
Blockchain Technology and Management : Technical Development<br></br>
Elective Courses (General)<br></br>
Machine Learning<br></br>
Machine Learning and Artificial Intelligence</h5>
        </div>
      </div>
    </div>
...
<div  className='col-md-6'>
                 ...
                 <img src="./bcaimages/mcaletter.webp " className='img-fluid'/> 
                 <p className='mt'>Amity Online's 2 year MCA program provides a 
                    strong foundation in programming languages, catering to both
                     professionals and beginners, fostering cross-functional 
                     expertise in a dynamic economy.</p>
                </div>
                </div>
                ...
                <div class="row">
                    <div className="col-md-4 ">
                        ...
                        <h1 className="p-3 div11h1">rs.7,083</h1>
                    </div>
                    ...
                    <div className="col-md-4 ">
                        <div className="p-3 bg-light div11h">
                            ...
                            <h1 className="p-2 div11h1">rs.42,500</h1>
                        </div>
                    </div>
