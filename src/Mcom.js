...
<div class="row mt-5">
        <div class="col-md-6">
            ...
            <h1 className="text-primary mt-5">M.com With Specialization<br></br>in Finanncial Management
  ...
  <div className="modal-dialog">
    <div className="modal-content">
      ...
      <div className="modal-footer">
        ...
        <div class="col-md-6">
         <img src="./bcaimages/mcomboy.webp" class="img-fluid"/>
    ...
    {/* close */} 
     ...
     <div className="row mt-5">
        ...
        <div className="col-md-3">
            ...
            <h1 className="mx-4 mt-5">RS.5,000</h1>
...
{/* <!-- 4th div close --> */}
   ...
   <div className="row mt-5 bcamain" id="section1">
            <div className="col-md-7 bca5">
              <h1 className="mt-5 mx-5 build">Prepare Yourself For The Global<br></br>Marketplace With India's First UGC<br></br>Recognized Online M.Com </h1> 
              <p  className="mt-5 mx-5 bcap"><i>
              Our Master of Commerce degree will equip you with in-depth <br></br>
              knowledge and specialisation in areas such as finance, marketing<br></br>
               and accounting.

Complete your degree online with an international<br></br>
 faculty and earn your place in leadership positions. <br></br>
 Develop analytical skills and shine among your peers in top sectors.<br></br>
              </i></p>
            </div>
        ...
        {/* <!-- fifth div close --></br>  */}
          ...
          {/* close */}
           ...
           <div className="mt-5 div8" id="section3">
            <div className="row">
              <div className="col-md-6">
    ...
    <div class="card">
      ...
      <div id="collapseOne" class="collapse show" data-bs-parent="#accordion">
        <div class="card-body">
        <h5 className='mbah5'>Advanced Financial Accounting<br></br>
Managerial Economics<br></br>
Financial Management<br></br>
Statistics for Management<br></br>
Professional communication
    ...
    <div class="card">
      ...
      <div id="collapseTwo" class="collapse" data-bs-parent="#accordion">
        <div class="card-body">
          <h5 className='mbah5'>Risk Management<br></br>
Business Research Methods<br></br>
Cognitive Analytics and Social Skills for Professional<br></br>
Security Analysis and Portfolio Management<br></br>
Financial Engineering</h5>
        </div>
      </div>
    </div>
    <div class="card">
      ...
      <div id="collapseThree" class="collapse" data-bs-parent="#accordion">
        <div class="card-body">
          <h5 className='mbah5'>Financial Reporting and Decision Making<br></br>
Minor Project<br></br>
Professional Ethics</h5>
        </div>
      </div>
    </div>
    <div class="card">
      ...
      <div id="collapsefour" class="collapse" data-bs-parent="#accordion">
        <div class="card-body">
         <h5 className='mbah5'>Treasury Management<br></br>
Dissertation</h5>
        </div>
      </div>
    </div>
...
<div  className='col-md-6'>
                 ...
                 <img src="./bcaimages/mcomletter.webp " className='img-fluid'/> 
                 <p className='mt'>Master of Commerce is a 2-year (4 semesters) program<br></br>
                     that aims to equip the graduates and working professionals with the<br></br>
                      requisite knowledge and skills in Financial Management. The program<br></br>
                       helps you gain knowledge of conventional general principles and financial<br></br>
                        management traits.</p>
                </div>
                </div>
                ...
                <div class="row">
                    <div className="col-md-4 ">
                        ...
                        <h1 className="p-3 div11h1">rs.5,000</h1>
                    </div>
                    ...
                    <div className="col-md-4 ">
                        <div className="p-3 bg-light div11h">
                            ...
                            <h1 className="p-2 div11h1">rs.30,000</h1>
                        </div>
                    </div>
                    <div className="col-md-4 ">
                      <div className="p-2 bg-light div11h">
                        <p className="p-4">full Course Fee</p>
                        <h1 className="p-3 div11h1">rs 1,20,000</h1>
                      </div>  
                    </div>
         ...
         <h5 className='mbah5'>Avail library resources at the Noida campus, online learning resources, and academic support services to enhance your learning.</h5>
              ...
              <Careerimpact/>
                ...
                <div className='impact mt-5 '  >
                  <h1 className='impacth1'>CAREER IMPACT :HOW WE HELP YOU<br></br>BUILD YOUR DREAM CAREER </h1> 
                  <hr></hr> 
                  <div className="row">
                    <div className='col-md-2'></div>
                    <div className="col-md-2 career" >
                        <div className='p-2'>
                        <img src="./bcaimages/c1.webp" className='img-fluid' height="100" width="80"/>
                        <h4>01.industry mentorship</h4>
                        <p><i><u>Personalized guidence from a career expert throught the academic journey</u></i></p>
                        </div>
                    </div>
                    {/* <div className='col-md-1'></div> */}
                    <div className="col-md-2 career">
                        <div className='p-2'>
                    <img src="./bcaimages/c2.webp" className='img-fluid' height="100" width="80"/>
                    <h4>02.Virtual placement Drives</h4>
                    <p><i><u>connect with employers & explore opportunities through interactive online events.</u></i></p>
                    </div>
                    </div>
                    {/* <div className='col-md-1'></div> */}
                    <div className="col-md-2 career">
                        <div className='p-2'>
                    <img src="./bcaimages/c3.webp" className='img-fluid' height="100" width="80"/>
                    <h4>03.masterclass</h4>
                    <p><i><u>Access Comprehensive help for resume building interview preparation & job placement.</u></i></p>
                    </div>
                    </div>
                    {/* <div className='col-md-1'></div> */}
                    <div className="col-md-2 career">
                        <div className='p-2'>
                    <img src="./bcaimages/c4.webp" className='img-fluid' height="100" width="80"/>
                    <h4>04.Profile building</h4>
                  <p> <i><u>Showcase your skills through hands-on projects for a strong professional profile.</u></i></p>
                    </div>
                    </div>
                  </div>
                </div>
