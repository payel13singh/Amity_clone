...
function Bcom(){
    ...
    <div class="row mt-5 m-3">
        <div class="col-md-6  bbadiv ms-5">
            <h2 className="program pgh1" >UG PROGRAM</h2>
            <h1 className="pgh2 mt-5 ">Bachelor of commerce(Online.com)
  ...
  <div className="modal-dialog">
    <div className="modal-content">
      ...
      <div className="modal-footer">
        ...
        <div class="col-md-6">
         <img src="./bcaimages/bcomgirl.webp" class="img-fluid"/>
        
        </div>
    </div>
    {/* close */} 

    {/* <div className="row bba2 ">
      <div className="col-md-6 bbadiv">
      <h2 className="program pgh1" >UG PROGRAM</h2>
            <h1 className="pg mt-5 ">Bachelor of commerce(Online.com)
        <br></br>Duration 3 year</h1>
       
      </div>
      <div className="col-md-6"> <img src="./bcaimages/bcomgirl.webp" class="img-fluid"/></div>
    </div> */}
...
{/* <!-- 4th div close --> */}
   ...
   <div className="row mt-5 bcamain" id="section1">
            <div className="col-md-7 bca5">
              ...
              Our Bachelors of Commerce Degree provides you with<br></br>
               a strong foundation in business and economics,<br></br>
                thereby opening up career opportunities in finance<br></br>
                 and accounting.Learn from an eminent international <br></br>
                 faculty and finish your degree online. Adapt to the<br></br>
                  ever-evolving job market and stay ahead of the curve.<br></br>
              </i></p>
            </div>
   ...
   2.Financial Accounting<br></br> 
    ...
    <div class="card">
      ...
      <div id="collapseThree" class="collapse" data-bs-parent="#accordion">
        <div class="card-body">
          <h5 className='mbah5'>1.Individual Excellence and Social Dynamic<br></br>
           2.Corporate Accounting <br></br>
            3.Cost Accounting<br></br>
              4.Direct Tax <br></br>
            5.Business Statistics<br></br>
    ...
    <div class="card">
      ...
      <div id="collapsefour" class="collapse" data-bs-parent="#accordion">
        <div class="card-body">
         <h5 className='mbah5'>1.Corporate Accounting II<br></br>
                  2.Direct Tax II</h5>
        </div>
      </div>
    </div>
...
<div  className='col-md-6'>
                 ...
                 <img src="./bcaimages/bcomletter.webp " className='img-fluid'/> 
                ...
                <div class="row">
                    <div className="col-md-4 ">
                        ...
                        <h1 className="p-3 div11h1">rs.2,639</h1>
                    </div>
                    ...
                    <div className="col-md-4 ">
                        <div className="p-3 bg-light div11h">
                            ...
                            <h1 className="p-2 div11h1">rs.16,500</h1>
                        </div>
                    </div>
                    <div className="col-md-4 ">
