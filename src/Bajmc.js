...
<div class="row mt-5">
        <div class="col-md-6">
            ...
            <h1 className="text-primary mt-5">Bachlor Of Arts in Journalism and<br></br>
            Mass Communication(online  BAJMC)
  ...
  <div className="modal-dialog">
    <div className="modal-content">
      ...
      <div className="modal-footer">
        ...
        <div class="col-md-6">
         <img src="./bcaimages/bajmcgirl.webp" class="img-fluid"/>
...
<div  className='col-md-6' id="section5">
                  <h5 className='degree'>ONLINE MBA DEGREE</h5>
                 <img src="./bcaimages/bajmcletter.webp " className='img-fluid'/> 
